...
@pytest.mark.parametrize("yaml_dir",[
                        'experiments/configs/tests/sweeper/basic/incorrect/algo_params',
                        'experiments/configs/tests/sweeper/basic/incorrect/meta_params',
                        'experiments/configs/tests/sweeper/basic/incorrect/first_level_keys',
                        'experiments/configs/tests/sweeper/basic/incorrect/config_param'
                        ])
def test_incorrect_yaml_files(yaml_dir: str, test_ids: List[int]) -> None:
    ...
    for yaml_file in yaml_dir.glob('*.yaml'):
        try: 
            _ = [_get_config(yaml_file, id) for id in test_ids]
...
@pytest.mark.parametrize("yaml_dir",[
                        'experiments/configs/tests/sweeper/basic/correct',
                        ])
...
@pytest.mark.parametrize("yaml_file, params",[
                        (
                            'experiments/configs/tests/sweeper/basic/correct/dqn.yaml', {
                            'id': 0,
                            'param_setting': 0,
                            'seed': 0,
                            'optimizer': {
